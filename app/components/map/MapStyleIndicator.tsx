...
interface MapStyleIndicatorProps {
  style: 'dark' | 'satellite' | 'satelliteStreets'
}

// A small visual indicator showing the current map style
export default function MapStyleIndicator({ style }: MapStyleIndicatorProps) {
  // Get an appropriate icon and label based on the style
  const getStyleInfo = () => {
    switch (style) {
      case 'dark':
        return {
      ...
      case 'satelliteStreets':
        return {
          icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
              <path d="M6.5 3c-1.051 0-2.093.04-3.125.117A1.49 1.49 0 002 4.607V10.5h9V4.606c0-.771-.59-1.43-1.375-1.489A41.568 41.568 0 006.5 3zM2 12v2.5A1.5 1.5 0 003.5 16h.041a3 3 0 015.918 0h.791a.75.75 0 00.75-.75v-3.5a.75.75 0 00-.75-.75H2z" />
